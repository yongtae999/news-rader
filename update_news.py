        ...
        for idx, keyword in enumerate(keywords):
            ...
            for item in items: # type: ignore
                ...
                blacklist = [
                    ...
                    # 주요 해외 국가명 원천 차단 (국내 뉴스만 취급하기 위해)
                    "미국", "중국", "일본", "러시아", "호주", "캐나다", "유럽", "영국", "프랑스", "독일", "인도",
                    # 종교 관련 주요 키워드 원천 차단 (사설/기획에 혼입 방지)
                    "목사", "교회", "예배", "기독교", "천주교", "불교", "스님", "사찰", "조계종", "신부", "수녀", "성당", "미사", "법회", "하나님", "예수", "신앙"
                ]
